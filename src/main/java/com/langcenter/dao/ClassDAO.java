...
public class ClassDAO {
    ...
    public List<SchoolClass> getByStatus(String status) throws Exception {
        List<SchoolClass> list = new ArrayList<>();
        try (Connection c = DBConnection.getConnection();
    ...
    public SchoolClass getById(int id) throws Exception {
        try (Connection c = DBConnection.getConnection();
    ...
    public boolean insert(SchoolClass cl) throws Exception {
    ...
    public boolean update(SchoolClass cl) throws Exception {
