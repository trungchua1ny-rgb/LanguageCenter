      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between align-items-center pt-3 mb-3">
            <div>
              <h5 class="card-title mb-0">Danh sách học viên</h5>
          ...
          <c:choose>
            <c:when test="${empty students}">
              <div class="text-center py-5 text-muted">
                ...
                <c:choose>
                  <c:when test="${not empty keyword}">
                    Không tìm thấy học viên nào với từ khóa "<strong>${keyword}</strong>".
                  </c:when>
                  ...
                  <tbody>
                    <c:forEach var="sv" items="${students}" varStatus="s">
                      <tr class="${sv.active ? '' : 'table-secondary opacity-75'}">
                        ...
                        <td>
                          <span class="badge rounded-pill bg-primary bg-opacity-10 text-primary fw-normal"
                        ...
                        <td>
                          <a href="${pageContext.request.contextPath}/admin/students?action=detail&id=${sv.id}"
                             class="btn btn-sm btn-outline-primary py-0 px-2 me-1" title="Xem chi tiết">
                            <i class="bi bi-eye"></i>
                          </a>
...
function confirmToggle(id, name, isActive) {
  ...
  document.getElementById('modal-title').textContent =
    isLock ? 'Khóa tài khoản' : 'Mở tài khoản';
